...
(function() {
  ...
  App.Router.map(function() {
    ...
    this.resource('works', function() {
      return this.route('onsale');
    });
    this.resource('work', {
      path: '/works/:work_id'
    });
    return this.resource('artists', function() {
  ...
  App.AboutController = Ember.Controller.extend({
    ...
    open: function() {
      return ((new Date()).getDay() === 6 ? 'Closed' : 'Open').property();
    }
  });
...
//# sourceMappingURL=app-coffee.map
